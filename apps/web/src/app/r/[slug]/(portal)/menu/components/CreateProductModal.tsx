...
/** Quick-create: name + price + category, same insert-item-then-"Regular"-
 *  variant flow the old inline page used. Everything else (image,
 *  description, extra variants, modifiers) is added in the full Product
 *  Editor, opened automatically once this succeeds. */
